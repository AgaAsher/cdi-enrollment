  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-white dark:bg-[#0d1117] transition-colors duration-300">
      ...
      <div className="w-full max-w-sm">
        {/* Card */}
        <div className="bg-white dark:bg-[#1a2035] rounded-3xl p-8 shadow-xl dark:shadow-2xl border border-slate-100 dark:border-white/8"
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-5">
              <div className="w-24 h-24 rounded-2xl bg-white shadow-md p-2 flex items-center justify-center">
                <Image src="/logo.png" alt="CDI" width={88} height={88} priority className="object-contain" />
              </div>
            </div>
            <h1 className="text-2xl font-bold text-[#0f1f6b] dark:text-white tracking-tight">Sign In</h1>
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Child Development Academy</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="admin@cdi-laos.edu.la"
                required
              />
            </div>
