      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 dark:border-white/8">
            ...
            <Link
              href="/enroll"
              className="flex items-center justify-center gap-2 w-full py-2.5 text-sm font-semibold text-[#0f1f6b] dark:text-white bg-slate-50 dark:bg-white/6 border border-slate-200 dark:border-white/10 rounded-xl hover:bg-slate-100 dark:hover:bg-white/10 hover:border-slate-300 dark:hover:border-white/20 transition-all"
            >
